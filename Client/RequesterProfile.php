...
if(isset($_REQUEST['nameupdate'])){
  if($_REQUEST['rName'] == ""){
    $passmsg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2 role="alert" >Fill Name Filed</div>';
  } else {
...
?>
      ...
      <button type="submit" class="btn btn-outline-light" style="background-color:#28a745" name="nameupdate">Update</button>
